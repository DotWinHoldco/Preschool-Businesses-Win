...
export const metadata = {
  ...
  description:
    'Sign in to the Crandall Christian Academy portal to manage enrollment, view schedules, and more.',
}
    ...
    <div className="min-h-screen flex flex-col bg-[#FAF9F5]">
      ...
      <footer className="py-5 px-4">
        <div className="flex flex-col items-center gap-1.5">
          ...
          <p className="font-questrial text-[10px] text-cca-ink/20">Where Little Minds Shine</p>
        </div>
      </footer>
    </div>
  )
