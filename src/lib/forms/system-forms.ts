...
const ENROLLMENT_APPLICATION: SystemFormTemplate = {
  ...
  description: 'Apply to enroll your child. Multi-child families can submit a single application.',
  mode: 'conversational',
  ...
  sections: [
    ...
    {
      title: 'Choose a program for each child',
      description: 'Each child can be enrolled in a different program.',
      page_number: 3,
      iterate_over_field_key: 'children',
    },
    {
  ...
  fields: [
    ...
    {
      field_key: 'parent_address_street',
      field_type: 'short_text',
    ...
    {
      field_key: 'other_parent_name',
      field_type: 'short_text',
      label: "Other parent's full name",
      page_number: 5,
      section_index: 4,
      sort_order: 20,
      logic_rules: [{ show_if: { field: 'has_other_parent', equals: true } }],
    },
    {
      field_key: 'other_parent_same_address',
      field_type: 'yes_no',
    ...
    {
      field_key: 'other_parent_address_street',
      field_type: 'short_text',
      label: "Other parent's street address",
      page_number: 5,
      section_index: 4,
      sort_order: 40,
    ...
    {
      field_key: 'other_parent_address_city',
      field_type: 'short_text',
      label: 'City',
      page_number: 5,
      section_index: 4,
    ...
    {
      field_key: 'other_parent_address_zip',
      field_type: 'short_text',
      label: 'ZIP code',
      page_number: 5,
      section_index: 4,
    ...
    },
    {
      ...
      field_type: 'short_text',
      label: 'Family name (e.g., The Smith Family)',
      page_number: 5,
      section_index: 4,
      sort_order: 80,
      is_required: true,
    ...
    {
      field_key: 'how_heard_other',
      field_type: 'short_text',
      label: 'Please specify',
      page_number: 5,
      section_index: 4,
      sort_order: 100,
      logic_rules: [{ show_if: { field: 'how_heard', equals: 'other' } }],
    },
    {
      field_key: 'referral_family_name',
      field_type: 'short_text',
      label: 'Who referred you?',
      page_number: 5,
      section_index: 4,
      sort_order: 110,
      logic_rules: [{ show_if: { field: 'how_heard', equals: 'referral' } }],
    },
    {
      field_key: 'faith_community',
      field_type: 'short_text',
      label: 'Church or faith community',
      description: 'Optional — we welcome families of all backgrounds.',
      page_number: 5,
      section_index: 4,
      sort_order: 120,
    },
    {
      field_key: 'has_sibling_enrolled',
      field_type: 'yes_no',
      label: 'Does another child in your family currently attend?',
      page_number: 5,
      section_index: 4,
      sort_order: 130,
    },
    {
      field_key: 'sibling_name',
      field_type: 'short_text',
      label: 'Sibling name',
      page_number: 5,
      section_index: 4,
      sort_order: 140,
      logic_rules: [{ show_if: { field: 'has_sibling_enrolled', equals: true } }],
    },
    {
      field_key: 'parent_goals',
      field_type: 'long_text',
    ...
    {
      field_key: 'agree_to_contact',
      field_type: 'legal_acceptance',
      label: 'I agree to be contacted regarding this application.',
      page_number: 6,
      section_index: 5,
      sort_order: 10,
      is_required: true,
    ...
    {
      field_key: 'agree_to_policies',
      field_type: 'legal_acceptance',
      label: 'I have read and agree to the school policies and handbook.',
      page_number: 6,
      section_index: 5,
      sort_order: 20,
      is_required: true,
    ...
    {
      field_key: 'acknowledge_accuracy',
      field_type: 'legal_acceptance',
    ...
    },
    {
      ...
      is_locked: true,
      is_system_field: true,
      config: { mode: 'one_time', amount_source: 'form.fee_amount_cents' },
    },
  ],
  actions: [
    { action_type: 'store', config: {}, sort_order: 10 },
    {
      ...
      config: { entity_type: 'enrollment_application', per_child: true },
      sort_order: 20,
    },
    {
      action_type: 'create_entity',
    ...
    {
      action_type: 'notify',
      config: { recipient: 'director', template: 'new_enrollment' },
      sort_order: 50,
    },
    {
      action_type: 'notify',
      config: { recipient: 'parent', template: 'enrollment_received' },
      sort_order: 60,
    },
